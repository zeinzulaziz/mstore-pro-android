...
const Images = {
  ...
  Banner: {
    Feature: require('@images/placeholderImage.png'),
    Man: require('@images/placeholderImage.png'),
    Woman: require('@images/placeholderImage.png'),
    Bag: require('@images/placeholderImage.png'),
  },
