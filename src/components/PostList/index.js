...
class PostList extends PureComponent {
  ...
  render() {
    ...
    if (!this.isProductList) {
      // Use layoutHome to determine columns for news
      if (this.props.layoutHome === Constants.Layout.twoColumn) {
        numColumns = 2;
      } else if (this.props.layoutHome === Constants.Layout.threeColumn) {
        numColumns = 3;
      } else {
        // Default to single column for simple, card, list layouts
        numColumns = 1;
      }
      styless = {};
    }
