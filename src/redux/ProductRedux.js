...
const types = {
  ...
  FETCH_ALL_COUPONS_PENDING: 'FETCH_ALL_COUPONS_PENDING',
  FETCH_ALL_COUPONS_SUCCESS: 'FETCH_ALL_COUPONS_SUCCESS',
  FETCH_ALL_COUPONS_FAILURE: 'FETCH_ALL_COUPONS_FAILURE',
...
export const actions = {
  ...
  fetchAllCoupons: async (dispatch) => {
    dispatch({ type: types.FETCH_ALL_COUPONS_PENDING });
    const json = await WooWorker.getAllCouponCode();

    if (json === undefined) {
      dispatch({
        type: types.FETCH_ALL_COUPONS_FAILURE,
        message: Languages.ErrorMessageRequest,
      });
    } else if (json.code) {
      dispatch({ type: types.FETCH_ALL_COUPONS_FAILURE, message: json.message });
    } else {
      dispatch({ type: types.FETCH_ALL_COUPONS_SUCCESS, coupons: json });
    }
  },
...
export const reducer = (state = initialState, action) => {
  ...
  switch (type) {
    ...
    case types.FETCH_ALL_COUPONS_PENDING: {
      return {
        ...state,
        isFetching: true,
        isFetchingCoupons: type === types.FETCH_ALL_COUPONS_PENDING,
        error: null,
        message: '',
      };
    }
    ...
    case types.FETCH_ALL_COUPONS_FAILURE: {
      return {
        ...state,
        isFetching: false,
        isFetchingCoupons: type === types.FETCH_ALL_COUPONS_FAILURE,
        error,
      };
    }
    ...
    case types.FETCH_ALL_COUPONS_SUCCESS: {
      return {
        ...state,
        isFetching: false,
        isFetchingCoupons: false,
